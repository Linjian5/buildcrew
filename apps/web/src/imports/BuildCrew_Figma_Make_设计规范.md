...
5. [组件库](#5-组件库)
6. [App Store 截图](#6-app-store-截图)
7. [Landing Page（官网）](#7-landing-page官网)
8. [Figma 文件结构与交付 Checklist](#8-figma-文件结构与交付-checklist)
...
### 6.1 Mac App Store (2560x1600, 5 张)
...
### 6.2 iOS App Store (1290x2796, 5 张)
